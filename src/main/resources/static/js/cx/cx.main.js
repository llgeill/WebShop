 ...
 * CX工具组件
 */
//var CX = CX || {Object:{},Dict:{},Page:{},Tags:{},Model:{},Validate:{},Date:{},Url:{},Ajax:{},File:{}};
var CX = CX || {};
$(function() {
	//复选框
	...
	CX={Object:{notNull:function(obj) {//判断某对象不为空..返回true 否则 false
		...
		Dict:{//ids 对应id值(多个逗号分隔).keys 对应key值(多个逗号分隔).type(可选)1.请选择，2.自定义数组。默认不填.dfstr (可选)自定义数组
				setSelect:function(ids,keys,type,dfstr){
					$.ajax({type:'POST',url:cxpath+'/backstage/dataDict/getDictSelect',data:{ids:ids,keys:keys},dataType:'json',success:function(data,textStatus){
		...
		Page:{//跳转分页
			  ...
			  setPage:function(formId,pageId,pagesize,pagenum,totalCount,fun){
			  	if(totalCount>0){
			  		...
			  		if(pagenum - 1 >= 1){html+="<li class='prev'><a onclick='CX.Page.jump(&apos;"+formId+"&apos;,1,&apos;"+fun+"&apos;)' href='#'>首页</a></li>";html+="<li class='prev'><a onclick='CX.Page.jump(&apos;"+formId+"&apos;,"+(pagenum - 1)+",&apos;"+fun+"&apos;)' href='#'>上页</a></li>";}
			  	    ...
			  	    //现在设2,和显示对应
			  		if(pagenum>2&&leng>3){html+="<li class='' ><a href='#' onclick='CX.Page.jump(&apos;"+formId+"&apos;,"+(pagenum-2)+",&apos;"+fun+"&apos;)' >..</a></li>";}
			  		for(var ii = start ; ii <= end; ii++){
			  			var page = (parseInt(ii));
			  			if(pagenum==page){html+="<li class='active' ><a href='#'>"+page+"</a></li>";}
			  			else{html+="<li><a onclick='CX.Page.jump(&apos;"+formId+"&apos;,"+ii+",&apos;"+fun+"&apos;)' href='#'>"+page+"</a></li>";}	
			  		}
			  		if(pagenum<=(leng-2)&&leng>3){html+="<li class='' ><a href='#' onclick='CX.Page.jump(&apos;"+formId+"&apos;,"+(pagenum+2)+",&apos;"+fun+"&apos;)' >..</a></li>";}
			  		if(pagenum + 1 <= leng){html+="<li class='next'><a onclick='CX.Page.jump(&apos;"+formId+"&apos;,"+(pagenum + 1)+",&apos;"+fun+"&apos;)' href='#'>下页</a></li>";html+="<li class='next'><a onclick='CX.Page.jump(&apos;"+formId+"&apos;,"+leng+",&apos;"+fun+"&apos;)' href='#'>尾页</a></li>";}
			  		...
			  		html+="<li ><a class='btn btn-mini btn-success' onclick='CX.Page.jumpCustom(&apos;"+formId+"&apos;,&apos;"+pageId+"&apos;,"+leng+",&apos;"+fun+"&apos;);' href='##'>跳转</a></li>";
			  		html+="<li class='disabled'><select onchange='CX.Page.setSize(&apos;"+formId+"&apos;,this.value,&apos;"+fun+"&apos;)' style='width:55px;float:left;' title='显示条数'>"+"<option value='5'  "+((pagesize==5)?"selected='selected'":"")+" >5</option>" +"<option value='10' "+((pagesize==10)?"selected='selected'":"")+" >10</option>" +"<option value='15' "+((pagesize==15)?"selected='selected'":"")+" >15</option>"+"</li>";
			  		pageul.append(html);
			  	}	
			  },
			  ...
			  setSimPage:function(formId,pageId,pagesize,pagenum,totalCount,fun){
			  	if(totalCount>0){
			  		...
			  		pageul.empty();
			  		var leng = parseInt((totalCount - 1)/pagesize)+1;
			  		if(pagenum - 1 >= 1){html+="<li class='prev'><a onclick='CX.Page.jump(&apos;"+formId+"&apos;,1,&apos;"+fun+"&apos;)' href='#'>首</a></li>";}
			  		...
			  		if(pagenum<=(leng-2)&&leng>3){html+="<li class='' ><a href='#' onclick='CX.Page.jump(&apos;"+formId+"&apos;,"+(pagenum+2)+",&apos;"+fun+"&apos;)' >..</a></li>";}
			  		if(pagenum + 1 <= leng){html+="<li class='next'><a onclick='CX.Page.jump(&apos;"+formId+"&apos;,"+leng+",&apos;"+fun+"&apos;)' href='#'>尾</a></li>";}
		...
		Tags:{//设置按钮用的方法,id 这行的id,pBtn 按钮组
			...
			setFunction:function(id,pBtn){
				...
				if(pBtn!=null&&pBtn.length>0){
					...
					for(var i=0;i<pBtn.length;i++){h+="<a href='#' title='"+CX.Object.notEmpty(pBtn[i].name)+"' onclick='"+CX.Object.notEmpty(pBtn[i].btnFun)+"(&apos;"+id+"&apos;)' class='aBtnNoTD' ><i class='"+pBtn[i].icon+" bigger-140'></i></a>";}
					h+="</div>";
					...
					for(var i=0;i<pBtn.length;i++){h+="<li><a href='#' title='"+CX.Object.notEmpty(pBtn[i].name)+"' onclick='"+CX.Object.notEmpty(pBtn[i].btnFun)+"(&apos;"+id+"&apos;)' class='aBtnNoTD' ><i class='"+pBtn[i].icon+" bigger-140'></i></a></li>";}
					h+="</ul></div></div>";		
					h+="</td>";
				}else{h+="<td></td>";}
				return h;
		...
		Model:{//loading框
			loading:function(Str){
				if(CX.Object.notNull(Str))$("#cxLoadingStr").empty().append(Str);
				else                      $("#cxLoadingStr").empty().append("数据读取中...");
				$("#cxLoading").removeClass('hide').dialog({dialogClass: "loading-no-close",minHeight:50,resizable: false,modal: true,show:{effect:"fade"},hide:{effect:"fade"}});
				},
			//关闭loading框
			loadingClose:function(){$("#cxLoading").dialog("close");},
				//Str 询问语句可以是html格式,fn  方法
			confirm:function(Str,fn){
				$("#cxConfirmStr").empty();
				if(CX.Object.notNull(Str)) $("#cxConfirmStr").append(Str);
				else                       $("#cxConfirmStr").append("确认吗？");
				$("#cxConfirm").removeClass('hide').dialog({resizable:false,modal:true,title:"<div class='widget-header'><h4 class='font-bold'>询问</h4></div>",title_html:true,show:{effect:"explode",pieces:9},hide:{effect:"explode",pieces:9},
			...
			info:function(Str,fn){
				if(CX.Object.notNull(Str)){$("#cxInfoStr").empty().append(Str);$("#cxInfo").removeClass('hide').dialog({resizable:false,dialogClass:"title-no-close",modal:true,title: "<div class='widget-header'><h4 class='font-bold'>提示</h4></div>",title_html: true,show:{effect:"explode",pieces:9},hide:{effect:"explode",pieces:9},buttons: [{html:"<i class='icon-ok bigger-110'></i>&nbsp;确认","class":"btn btn-primary btn-xs",click:function(){$(this).dialog("close");if(typeof(fn) == 'function'){fn.call(this);}}}]}); }
			},
			//Str 语句可以是html格式（如：<span>保存成功</span>）,fn 方法
			error:function(Str){
				if(CX.Object.notNull(Str)){$("#cxErrorStr").empty().append(Str);$("#cxError").removeClass('hide').dialog({resizable:false,dialogClass:"title-no-close",modal:true,title:"<div class='widget-header'><h4 class='font-bold red'>错误</h4></div>",title_html: true,show:{effect:"shake",duration:100},hide:{effect:"explode"},buttons: [{html:"<i class='icon-ok bigger-110'></i>&nbsp;确认","class":"btn btn-primary btn-xs",click:function(){$(this).dialog("close");}}]});}
			},
			//divId,fn 方法
			check:function(id,title,fn){
				$("#"+id).removeClass('hide').dialog({resizable:false,modal:true,title:"<div class='widget-header'><h4 class='smaller'>"+(CX.Object.notNull(title)?title:"查看")+"</h4></div>",title_html:true,buttons:[{html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",click:function(){$(this).dialog("close");if(typeof(fn) == 'function'){fn.call(this);}}}]});
			},
			edit:function(id,title,savefn,cancelfn){
				$("#"+id).removeClass('hide').dialog({resizable:false,modal:true,title:"<div class='widget-header'><h4 class='smaller'>"+(CX.Object.notNull(title)?title:"修改")+"</h4></div>",title_html:true,buttons:[{html: "<i class='icon-ok bigger-110'></i>&nbsp;保存","class":"btn btn-primary btn-xs",click:function(){if(typeof(savefn) == 'function'){savefn.call(this);}}},{html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",click:function(){$(this).dialog("close");if(typeof(cancelfn) == 'function'){cancelfn.call(this);}}}]});
			},
			//审核
			audit:function(id,title,savefn,rejectfn,cancelfn){
				$("#"+id).removeClass('hide').dialog({resizable:false,modal:true,title:"<div class='widget-header'><h4 class='smaller'>"+(CX.Object.notNull(title)?title:"审核")+"</h4></div>",title_html:true,buttons:[{html: "<i class='icon-ok bigger-110'></i>&nbsp;同意","class":"btn btn-primary btn-xs",click:function(){if(typeof(savefn) == 'function'){savefn.call(this);}}},{html: "<i class='icon-undo bigger-110'></i>&nbsp;驳回","class":"btn btn-danger btn-xs",click:function(){if(typeof(rejectfn) == 'function'){rejectfn.call(this);}}},{html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",click:function(){$(this).dialog("close");if(typeof(cancelfn) == 'function'){cancelfn.call(this);}}}]});
			},
			//调整
			adjust:function(id,title,againfn,abandonfn,cancelfn){
				$("#"+id).removeClass('hide').dialog({resizable:false,modal:true,title:"<div class='widget-header'><h4 class='smaller'>"+(CX.Object.notNull(title)?title:"调整")+"</h4></div>",title_html:true,buttons:[{html: "<i class='icon-ok bigger-110'></i>&nbsp;提交","class":"btn btn-primary btn-xs",click:function(){if(typeof(againfn) == 'function'){againfn.call(this);}}},{html: "<i class='icon-flag-alt bigger-110'></i>&nbsp;放弃","class":"btn btn-danger btn-xs",click:function(){if(typeof(abandonfn) == 'function'){abandonfn.call(this);}}},{html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",click:function(){$(this).dialog("close");if(typeof(cancelfn) == 'function'){cancelfn.call(this);}}}]});
			}
		},
		Validate:{//判断是否是英文数字,是返回true，不是返回false
				  ...
				  //表单验证fromId,使用方法 在表单必须使用cxValidate属性
				  form:function(fromId,side) {var res=true;side=CX.Object.notNull(side)?side:1;
				  	$('#'+fromId+" input[cxValidate]").each(function(){
				  		if(res==false)return;var that=$(this);
				  		var cxValidate = $(this).attr("cxValidate").split(",");
				  		$.each(cxValidate,function(n,v){
				  			if(res==false)return;
				  			if(res=='llg')return;
				  			if(v=='required'){
				  				if(!CX.Object.notNull(that.val())){
				  					that.tips({
										side:side,msg : "必要字段！",bg:'#FF2D2D',time:1
				  					});
				  					that.focus();
				  					res=false;
				  				}}
				  			else if(v=='email'){if(CX.Object.notNull(that.val())){if(!CX.Validate.isEmail(that.val())){that.tips({side:side,msg : "电子邮箱不正确！",bg :'#FF2D2D',time:1});that.focus();res=false;}}}
				  			else if(v=='date'){if(CX.Object.notNull(that.val())){if(!CX.Validate.isDate(that.val())){that.tips({side:side,msg : "日期格式不正确！",bg :'#FF2D2D',time:1});that.focus();res=false;}}}
				  			else if(v=='datetime'){if(CX.Object.notNull(that.val())){if(!CX.Validate.isDatetime(that.val())){that.tips({side:side,msg : "日期时间格式不正确！",bg :'#FF2D2D',time:1});that.focus();res=false;}}}
				  			else if(v=='numrange'){if(CX.Object.notNull(that.val())){var min=that.attr("min");var max=that.attr("max");if(!CX.Validate.numrange(that.val(),min,max)){that.tips({side:side,msg : "数字范围："+min+"~"+max,bg :'#FF2D2D',time:1});that.focus();res=false;}}}
				  			else if(v=='numrangeth'){if(CX.Object.notNull(that.val())){var min=that.attr("min");var max=that.attr("max");		if(!CX.Validate.numrangeth(that.val(),min,max)){that.tips({side:side,msg :"数字范围："+min+"~"+max,bg :'#FF2D2D',time:1});that.focus();res=false;}}}
				  			else if(v=='en'){if(CX.Object.notNull(that.val())){if(!CX.Validate.isEn(that.val())){that.tips({side:side,msg:"只能输入英文",bg :'#FF2D2D',time:1});that.focus();res=false;}}}
				  			else if(v=='ennum'){if(CX.Object.notNull(that.val())){if(!CX.Validate.isEnNum(that.val())){that.tips({side:side,msg:"只能输入英文或数字",bg :'#FF2D2D',time:1});that.focus();res=false;}}}
				  			//extend
				          });});
				  		return res;}
				  },
		Date:{//时间格式化(默认),time 时间
			  Default:function(time){return CX.Object.notNull(time)?(new Date(time).Format("yyyy-MM-dd  hh:mm:ss")):" ";},
			  //时间格式化,time 时间,fmt 格式
			  Format:function(time,fmt){return CX.Object.notNull(time)?(new Date(time).Format(fmt)):"";}
		},
		...
		Ajax:{//异步请求, form表单ID,url请求路径,param参数对象,如：{a:'test',b:2},fn回调函数
			doRequest:function(form,url,param,fn){var params = form || param || {};if (typeof form == 'string'){params = $.extend(param || {},CX.Object.serialize($("#" + form)),{menu:CX.Url.getParam("menu")});}$.ajax({type:'POST',url:url,data:params,dataType:'json',success:function(data, textStatus) { if(data.res==1){if (typeof(fn)=='function'){fn.call(this, data);}}else if(!data.res){if (typeof(fn) == 'function') {fn.call(this, data);}}else{if(CX.Object.notNull(data.resMsg))CX.Model.error(data.resMsg);}},error:function(){return;},beforeSend:function(){},complete:function(){}});},
		    req:function(form,url,param,fn){var params = form || param || {};if (typeof form == 'string'){params = $.extend(param || {},CX.Object.serialize($("#" + form)),{menu:CX.Url.getParam("menu")});}$.ajax({type:'POST',url:url,data:params,dataType:'json',success:function(data, textStatus) {if (typeof(fn)=='function'){fn.call(this, data);}},error:function(){return;},beforeSend:function(){},complete:function(){}});}
			},
		File:{
			//obj:对象传this, aFmats:允许格式,用"|"分隔
			fileType:function(obj,aFmats){
				if(CX.Object.notNull(aFmats)){var fileType=obj.value.substr(obj.value.lastIndexOf(".")+1).toLowerCase();//获得文件后缀名
